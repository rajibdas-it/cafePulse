...
const Home = () => {
  return (
    <div className="min-h-screen flex flex-col lg:flex-row lg:justify-between justify-center items-center lg:px-32 px-5 gap-10 bg-gradient-to-r from-[#FFDCAB] to-[#AB6B2E]">
      ...
      <div className="relative">
        ...
        <div className="absolute bg-white px-8 py-2 rounded-full bottom-0 -left-10 ">
          <h2>Cappuccino</h2>
        </div>
      </div>
    </div>
