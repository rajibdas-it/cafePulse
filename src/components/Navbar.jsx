    ...
    <div className="fixed w-full z-10">
      <div>
        ...
        <div
          ...
          } lg:hidden flex flex-col absolute bg-black text-white left-0 top-16 font-semibold text-2xl text-center pt-8 pb-6 gap-8 w-full h-fit transition-transform duration-300`}
        >
